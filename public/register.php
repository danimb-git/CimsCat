    ...
    <section class="seccion login">
        <div class="contenedor">
            ...
            <div class="login__card">
                <form action="/process_register.php" method="post" enctype="multipart/form-data" class="login__form" novalidate>
                    ...
                    <div class="login__grupo">
                        <label for="foto" class="login__label">Foto de perfil (JPG, PNG o WEBP)</label>
                        <input type="file" id="foto" name="foto" class="login__input" accept="image/*">
                        <small class="login__ayuda">Mida màxima recomanada: 2&nbsp;MB.</small>
                    </div>
